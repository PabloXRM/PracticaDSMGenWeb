...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: PracticaDSMGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("PracticaDSMGenNHibernate", "nhibernateUser", "nhibernatePass");
