...
/*PROTECTED REGION ID(usingPracticaDSMGen.ApplicationCore.CP.PracticaDSM_Pedido_cancelarPedido) ENABLED START*/
...
{
        /*PROTECTED REGION ID(PracticaDSMGen.ApplicationCore.CP.PracticaDSM_Pedido_cancelarPedido) ENABLED START*/
        ...
        try
        {
                ...
                foreach (LineaPedidoEN linea in pedidoEN.LineaPedido) {
                        ...
                        productoCEN.IncrementarStock (productoEN.Id, linea.Cantidad);
                }

                pedidoEN.EstadoPedido = Enumerated.PracticaDSM.EstadoPedidoEnum.cancelado;
